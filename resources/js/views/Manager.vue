  ...
  <div class="col-12">
    <div class="col-12 text-left">
      <a
        ...
        ><span class="material-icons">create_new_folder</span> Nueva Carpeta</a
      >
    </div>
          ...
          <div class="modal-body">
            <div class="card">
              <div class="card-header card-header-primary text-center">
                <h4 v-if="update == 0" class="card-title">
                  <strong>Crear Carpeta</strong>
                </h4>
                <h4 v-if="update != 0" class="card-title">
                  <strong>Editar Carpeta</strong>
                </h4>
              </div>
              <div class="card-body">
